...
const services = [
  ...
  {
    title: 'UI/UX Design',
    desc: 'Intuitive and visually stunning interfaces that prioritize user experience.',
    icon: Palette,
  ...
  },
  {
    ...
    desc: 'Strategic content creation and community management to grow your brand.',
    icon: Share2,
  ...
  },
  {
    ...
    desc: 'Compelling visual assets that communicate your brand message effectively.',
    icon: PenTool,
  ...
  {
    title: 'Branding',
    desc: 'Comprehensive brand identities that resonate with your target audience.',
    icon: Globe,
  ...
  {
    title: 'SEO & Marketing',
    desc: 'Data-driven strategies to increase visibility and drive organic traffic.',
    icon: Search,
          ...
          {services.map((service, i) => (
            ...
            >
              <div className="flex-1 space-y-8">
                ...
                <button className="px-8 py-4 bg-[#2F281D] text-[#FDF8EC] rounded-full font-bold hover:bg-[#997F6C] transition-all flex items-center gap-2 group">
