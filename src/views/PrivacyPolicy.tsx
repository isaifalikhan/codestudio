  ...
  return (
    ...
    >
      <section className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-display font-bold text-[#14171F] mb-8">
          Privacy <span className="text-[#14171F]/40 italic">Policy</span>
        </h1>
        <p className="text-[#14171F]/60 mb-12">Last updated: April 2026</p>

        <div className="prose prose-lg text-[#14171F]/80 space-y-8">
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">2. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">3. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">4. Sharing and Disclosure</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">6. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">7. Cookies and similar technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">8. Third-party advertising (Google)</h2>
            <p>
            ...
            <p>
              ...
              <a
                ...
                className="text-[#D98A2C] font-bold hover:underline"
                target="_blank"
              ...
              <a href="https://www.aboutads.info" className="text-[#D98A2C] font-bold hover:underline" target="_blank" rel="noopener noreferrer">
                aboutads.info
              </a>
              .
            </p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">9. Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">10. Children&apos;s privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">11. Contact</h2>
            <p>
              For privacy-related questions:{' '}
              <a href="mailto:hello@codexstudio.com" className="text-[#D98A2C] font-bold hover:underline">
                hello@codexstudio.com
              </a>
              . Location: Islamabad, Pakistan.               You may also read our{' '}
              <Link href="/editorial" className="text-[#D98A2C] font-bold hover:underline">
                editorial standards
              </Link>{' '}
        ...
        <p className="mt-16">
          <Link href="/" className="text-[#D98A2C] font-bold hover:underline">← Back to Home</Link>
        </p>
      </section>
    </motion.div>
  );
