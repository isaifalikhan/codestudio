  ...
  return (
    ...
    >
      <article className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
        <p className="text-[#D98A2C] font-bold uppercase tracking-widest text-sm mb-4">Publisher standards</p>
        <h1 className="text-4xl md:text-6xl font-display font-bold text-[#14171F] mb-8">
          Editorial &amp; content <span className="text-[#14171F]/40 italic">standards</span>
        </h1>
        <p className="text-[#14171F]/60 mb-12">Last updated: April 2026</p>

        <div className="prose prose-lg text-[#14171F]/80 space-y-8 max-w-none">
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">Why this page exists</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">What we publish</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">Originality and attribution</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">Responsible use of media and download tools</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">Transparency and identity</h2>
            <p>
              We are CodexStudio, an independent studio. We do not claim to be Google, Meta, or any other company. Our{' '}
              <Link href="/about" className="text-[#D98A2C] font-bold hover:underline">
                About
              </Link>{' '}
              and{' '}
              <Link href="/team" className="text-[#D98A2C] font-bold hover:underline">
                Team
              </Link>{' '}
              pages describe who we are. Contact details on{' '}
              <Link href="/contact" className="text-[#D98A2C] font-bold hover:underline">
                Contact
              </Link>{' '}
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-[#14171F] mt-12 mb-4">Corrections and feedback</h2>
            <p>
        ...
        <p className="mt-16 flex flex-wrap gap-4">
          <Link href="/privacy" className="text-[#D98A2C] font-bold hover:underline">
            Privacy Policy
          </Link>
          <span className="text-[#14171F]/30">·</span>
          <Link href="/terms" className="text-[#D98A2C] font-bold hover:underline">
            Terms &amp; Conditions
          </Link>
          <span className="text-[#14171F]/30">·</span>
          <Link href="/" className="text-[#D98A2C] font-bold hover:underline">
            ← Home
          </Link>
        </p>
      </article>
