...
export const metadata: Metadata = {
  title: { absolute: '50 Best Free Resources for Developers | CodexStudio' },
  description:
    ...
    <div className="bg-[#F6F4EC] min-h-screen">
      ...
      <section className="pt-12 pb-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-[#14171F]/80 mb-6">
            We also built our own free tools — <Link href="/tools" className="text-[#D98A2C] font-semibold hover:underline">Try 100+ tools we made →</Link>
          </p>
      ...
      <section className="py-6 px-6 border-y border-[#14171F]/10 bg-[#ECE7D9]/50">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-8 md:gap-12 text-center">
          <span className="text-[#14171F] font-bold">50 Tools Curated</span>
          <span className="text-[#14171F]/60">·</span>
          <span className="text-[#14171F] font-bold">9 Categories</span>
          <span className="text-[#14171F]/60">·</span>
          <span className="text-[#14171F] font-bold">100% Free</span>
          <span className="text-[#14171F]/60">·</span>
          <span className="text-[#14171F] font-bold">Updated 2026</span>
        </div>
      </section>
      ...
      <section className="py-16 px-6 border-t border-[#14171F]/10">
        <div className="max-w-3xl mx-auto prose prose-lg prose-[#14171F]">
          ...
          <p className="text-[#14171F]/80 leading-relaxed">
            ...
            <Link href="/resources/design" className="text-[#D98A2C] font-semibold hover:underline">
              Design category
            </Link>
            .
          </p>
          ...
          <p className="text-[#14171F]/80 leading-relaxed">
            ...
            <Link href="/resources/ai" className="text-[#D98A2C] font-semibold hover:underline">
              AI Tools category
            </Link>
            .
          </p>
          ...
          <p className="text-[#14171F]/80 leading-relaxed">
            ...
            in our{' '}
            <Link href="/resources/seo" className="text-[#D98A2C] font-semibold hover:underline">
              SEO category
            </Link>
            .
          </p>
          ...
          <p className="text-[#14171F]/80 leading-relaxed">
            ...
            in our{' '}
            <Link href="/resources/dev-tools" className="text-[#D98A2C] font-semibold hover:underline">
              Dev Tools category
            </Link>
            .
          </p>
          ...
          <div className="space-y-2 not-prose">
            <details className="group rounded-xl border border-[#14171F]/10 bg-[#F6F4EC] overflow-hidden">
              <summary className="px-5 py-4 font-semibold text-[#14171F] cursor-pointer list-none flex items-center justify-between">
                Are all these tools really free?
                <span className="text-[#D98A2C] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="px-5 pb-4 text-[#14171F]/70 leading-relaxed">
      ...
      {/* Bottom links */}
      <section className="py-10 px-6 border-t border-[#14171F]/10">
        <div className="max-w-3xl mx-auto text-center space-y-2">
          <p className="text-[#14171F]/80">
            Want a custom tool built for your business? <Link href="/contact" className="text-[#D98A2C] font-semibold hover:underline">Talk to CodexStudio →</Link>
          </p>
          <p className="text-[#14171F]/70">
            Read our blog: <Link href="/blog" className="text-[#D98A2C] font-semibold hover:underline">Web development insights →</Link>
          </p>
        </div>
      </section>

      {/* Related */}
      <section className="py-12 px-6 border-t border-[#14171F]/10 bg-[#ECE7D9]/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl font-display font-bold text-[#14171F] mb-6 text-center">
            Explore Our Work
          </h2>
          <p className="text-[#14171F]/70 text-center mb-6">
            We also build our own tools — try them free at <Link href="/tools" className="text-[#D98A2C] font-semibold hover:underline">/tools</Link>.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="/tools" className="text-[#D98A2C] font-semibold hover:underline">
              Free Tools (40)
            </Link>
            <Link href="/portfolio" className="text-[#D98A2C] font-semibold hover:underline">
              Portfolio
            </Link>
            <Link href="/services" className="text-[#D98A2C] font-semibold hover:underline">
              Services
            </Link>
            <Link href="/blog" className="text-[#D98A2C] font-semibold hover:underline">
              Blog
            </Link>
          </div>
        </div>
