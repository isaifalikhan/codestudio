...
export default function IslamabadLocationPage() {
  return (
    <div className="bg-[#F6F4EC] min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-display font-bold text-[#14171F]">Web Development Services in Islamabad, Pakistan</h1>
        <p className="mt-6 text-[#14171F]/75 leading-relaxed">
        ...
        <p className="mt-4 text-[#14171F]/75 leading-relaxed">
        ...
        <Link href="/contact" className="inline-flex mt-8 px-6 py-3 rounded-full bg-[#14171F] text-[#F6F4EC] font-bold">Start a Project</Link>
      </div>
    </div>
  );
}
