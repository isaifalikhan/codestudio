...
export const tools: Tool[] = [
  ...
  { slug: 'tiktok-downloader', name: 'TikTok Video Downloader', category: 'Video Tools', emoji: '🎵', tagline: 'Download TikTok videos without watermark', description: 'Free TikTok video downloader. Save TikTok videos without watermark in MP4 HD quality. Paste any TikTok link and download instantly. No signup.', keywords: ['tiktok downloader', 'download tiktok video without watermark', 'tiktok video saver', 'save tiktok video free'], buildType: 'client' },
...
export const toolCategories = [
  { id: 'all', label: 'All 140 Tools', count: 140 },
  ...
  { id: 'Developer Tools', label: 'Developer Tools', count: 19 },
